   ...
   /* void animal_sound() override
    {
     ...
     virtual void animal_sound()    //sobreescribe funct Animal (Vtables)
    {
        std::cout << "miau";
    };
};
...
//Animal* pd = &c; //si la funct no es virtual imprime "aaa"
//pd->animal_sound();
...
public:
    ...
    void run() final    //no se va a poder sobreescribir esta función virtual en ninguna herencia más
    {
